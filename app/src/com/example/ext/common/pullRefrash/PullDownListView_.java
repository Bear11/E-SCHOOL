package com.example.ext.common.pullRefrash;
...
public class PullDownListView_ extends FrameLayout implements
	...
	private class CheckForLongPress2 implements Runnable {
		public void run() {
			...
			PullDownListView_.super.dispatchTouchEvent(e);
		}
	}
	...
	public interface OnRefreshListioner {
		public abstract void onRefresh_();

		public abstract void onLoadMore_();
	}
	/**
	 * 直接new时调用的构造方法 
	 * @param context
	 */
	public PullDownListView_(Context context) {
		super(context);
	 ...
	 * @param context
	 */
	public PullDownListView_(Context context, AttributeSet att) {
		super(context, att);

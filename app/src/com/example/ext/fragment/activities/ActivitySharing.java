...
public class ActivitySharing extends Fragment implements OnCheckedChangeListener{
   ...
   // private ImageView iv_add;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		parentView = inflater.inflate(R.layout.activity_sharing, container, false);
	...
	//	iv_add = (ImageView) parentView.findViewById(R.id.iv_add); 
		...
		ActivityRecruitment tzf=new ActivityRecruitment();
		SharingCenter dtf=new SharingCenter();
		list.add(tzf);
		list.add(dtf);

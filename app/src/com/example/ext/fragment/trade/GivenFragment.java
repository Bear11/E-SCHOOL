...
public class GivenFragment extends Fragment implements PullDownListView.OnRefreshListioner, AtCallback {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		parentView = inflater.inflate(R.layout.givenpage, container, false);// view_pager
	...
	protected String initData() {
		...
		map.put("flag", "1"); //給map数组传一个flag值为0，标识这边是失物，1为赠品

...
public interface MyShareBo {
	...
	public abstract void saveMyShareBo(MyShare myShare) throws Exception;
	/**
	 * 
	 * @param MyShare
	 * @throws Exception
	 ...
	 */
	public abstract void deleteMyShareBo(int id) throws Exception;
	/**
	 * 
	 * @param MyShare
	 * @throws Exception

...
public class CollectShare {
	...
	public String toString() {
		return "CollectShare [id=" + id + ", userAct=" + userAct
				+ ", imageUrl=" + imageUrl + ", DISCRIBE=" + DISCRIBE
				+ ", TYPEID=" + TYPEID + ", PICTURE=" + PICTURE + ", PERSONID="
				+ PERSONID + ", STATE=" + STATE + ", PLAYTIME=" + PLAYTIME

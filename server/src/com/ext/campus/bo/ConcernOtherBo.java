...
public interface ConcernOtherBo {
	 ...
	 */
	public abstract void saveConcernOtherBo(ConcernOther scenery) throws Exception;
	 ...
	 */
	public abstract void deleteConcernOtherBo(int id) throws Exception;
	/**
	 * 
	 * @param Activities
	 * @throws Exception

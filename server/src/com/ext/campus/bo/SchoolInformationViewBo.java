...
public interface SchoolInformationViewBo {
	/**
	 * 
	 ...
	 */
	public abstract void saveSchoolInformationViewBo(SchoolInformationView scenery) throws Exception;
	 ...
	 */
	public abstract void deleteSchoolInformationViewBo(int id) throws Exception;
	/**
	 * 
	 * @param Activities
	 * @throws Exception
	 ...
	 */
	public abstract List<SchoolInformationView> findSchoolInformation(String  ID) throws Exception;
}

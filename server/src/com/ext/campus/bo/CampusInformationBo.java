...
public interface CampusInformationBo {
	/**
	 * 
	 ...
	 */
	public abstract void saveCampusInformationDao(CampusInformation scenery) throws Exception;
	 ...
	 */
	public abstract void deleteCampusInformationDao(int id) throws Exception;
	/**
	 * 
	 * @param Activities
	 * @throws Exception
	 ...
	 * 
	 */
	public abstract List<CampusInformation> findCampusInformation(String  userAct) throws Exception;

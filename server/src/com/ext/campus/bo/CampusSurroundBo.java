...
public interface CampusSurroundBo {
	/**
	 * 
	 ...
	 */
	public abstract void saveCampusSurroundBo(CampusSurround scenery) throws Exception;
	 ...
	 */
	public abstract void deleteCampusSurroundnBo(int id) throws Exception;
	/**
	 * 
	 * @param Activities
	 * @throws Exception
	 ...
	 */
	public List<CampusSurround> findCampusSurround(String userAct)throws Exception;
